    ...
    >
        ...
        >
          ...
          >
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="Cloud, web programming, AI, design "
              {...getOverrideProps(
                overrides,
                "Ut enim ad minim veniam quis nostrud"
              )}
            ...
            <Text
              ...
              padding="0px 0px 0px 0px"
              whiteSpace="pre-wrap"
              children="My thoughts, notes, and takeaways on the emerging technologies that I am interested in, expermenting with, and using in production"
              {...getOverrideProps(
                overrides,
                "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco."
              )}
      ...
      >
        <Image
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          src="https://i.imgur.com/Spep262.png"
          id="hero-image"
